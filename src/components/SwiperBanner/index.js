...
export default class extends Component {
    ...
    scrollManual = (index, animated = true) => {
    ...
    render() {
        ...
        if (total > 1) {
            ...
            pages = keys.map((page, i) => {
                if (loadMinimal) {
                    if (
                        (i >= index + loopVal - loadMinimalSize && i <= index + loopVal + loadMinimalSize) ||
